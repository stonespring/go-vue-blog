...
<template>
    <div class="rightlistBox">
        <section >
            <div class="r1-head">
                <img :src="this.$store.state.themeObj.center_smailimg?this.$store.state.themeObj.center_smailimg:'static/img/right.jpeg'" alt="">
        ...
        data() { //选项 / 数据
            return {
                ...
                catchMeObj:{//抓住我 个人信息
                    ...
                    Spring:{
                        git: 'https://github.com/stonespring',
                ...
                isAimee:this.$store.state.themeObj.user_start!=0?"Spring":"Qinlh"//判断是哪个的博客
            }
        },
        methods: { //事件处理器
            //do you love me  点击
