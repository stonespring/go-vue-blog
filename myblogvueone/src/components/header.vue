				...
				<div class="headBox">
					<el-menu :default-active="activeIndex" class="el-menu-demo" mode="horizontal" @select="handleSelect" :router="true">
						...
						<el-submenu index="/Share">
							<template slot="title"><i class="fa fa-wa fa-archive"></i> 栏目</template>
...
<!--&lt;!&ndash;			<a href="#/Aboutme">&ndash;&gt;-->
<!--&lt;!&ndash;                    <img :src="this.$store.state.themeObj.head_portrait?this.$store.state.themeObj.head_portrait:'static/img/tou.png'" alt="">&ndash;&gt;-->
<!--&lt;!&ndash;                </a>&ndash;&gt;-->
<!--&lt;!&ndash;			<h2 class="h-description">&ndash;&gt;-->
<!--&lt;!&ndash;                    <a href="#/Aboutme">&ndash;&gt;-->
<!--&lt;!&ndash;                        {{this.$store.state.themeObj.autograph?this.$store.state.themeObj.autograph:"Write the Code. Change the World."}}&ndash;&gt;-->
<!--&lt;!&ndash;                    </a>&ndash;&gt;-->
<!--&lt;!&ndash;                </h2>&ndash;&gt;-->
<!--		</div>-->
	</div>
