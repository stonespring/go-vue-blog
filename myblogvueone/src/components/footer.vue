...
<template>
    ...
    <div v-if="this.$store.state.themeObj.user_start!=0" class="footBack footBackQian">
        ...
        <div class="fcontainer">
            ...
            <p>
                © 2018 <a href="#">Mango Ya</a>. 由 <a href="https://cn.vuejs.org/" target="_blank">Vue</a> 强力驱动. Theme By <a href="https://diygod.me/" target="_blank">diygod.me</a>. 备案号：湘ICP备2022008552号.
            </p>
            <p>
                <span>Made with</span> <img class="fheart" src="static/img/heart02.png"/>  <span>by Spring.</span>
            </p>
        </div>
    </div>
    <!-- Qinlh的 -->
    <div v-else class="footBack footBackHui">
        ...
        <div class="fcontainer">
            ...
            <p>
                © 2018 <a href="#">QinlhBlog</a>. 由 <a href="https://cn.vuejs.org/" target="_blank">Vue</a> 强力驱动. Theme By <a href="https://diygod.me/" target="_blank">diygod.me</a>. 备案号：湘ICP备2022008552号.
            </p>
            <p>
